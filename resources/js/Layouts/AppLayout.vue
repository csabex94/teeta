<template>
    <div class="flex h-screen bg-gray-800">
            ...
            <div>
                <div class="text-white">
                    <div class="flex p-2  bg-gray-800">
                        <div class="flex py-3 px-2 items-end">
                            <p class="text-2xl text-green-500 font-semibold">TEETA</p><p class=" font-semibold italic">Reminder</p>
                        </div>
                    </div>
        ...
        <div class="flex flex-col w-full h-full overflow-y-auto">
            <header class="z-40 flex items-center h-18 py-4 bg-gray-800  px-5">
                <div class="w-full" />

                <div class="w-11 cursor-pointer mr-5 rounded-full h-10 flex items-center hover:bg-green-400 text-green-400 hover:text-white justify-center bg-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                    </svg>
                </div>

                <div @click="logout" class="w-11 cursor-pointer rounded-full h-10 flex items-center text-green-400 hover:bg-green-400 hover:text-white justify-center bg-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <main class="flex-grow">
                <div class="mb-4 mt-5 py-10 px-8 mx-4 rounded-3xl bg-gray-100 border-4 height border-green-400">
